...
namespace KinematicCharacterController.Walkthrough.NoClipState
{
    public class MyPlayer : MonoBehaviour
    {
        ...
        private void HandleCharacterInput()
        {
            ...
            characterInputs.JumpHeld = Keyboard.current?.spaceKey.isPressed ?? false;
            characterInputs.CrouchDown = Keyboard.current?.cKey.wasPressedThisFrame ?? false;
            characterInputs.CrouchUp = Keyboard.current?.cKey.wasReleasedThisFrame ?? false;
            characterInputs.CrouchHeld = Keyboard.current?.cKey.isPressed ?? false;
            characterInputs.NoClipDown = Keyboard.current?.qKey.wasReleasedThisFrame ?? false;
